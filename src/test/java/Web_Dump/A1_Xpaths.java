...
public class A1_Xpaths extends A6_TestData_And_MainMethod_To_Run_With_User_Input{
		...
		//Number of Row
		public String NumberOfRowXpath="//td[contains(@class,'testStepTable fontPoppinsRegular')]/button";
		//First Row As To Be Added Icon
		public String FirstRowAsToBeAddedIconXpath="(//td[contains(@class,'testStepTable fontPoppinsRegular')]//button)[2]";
		...
		//Variables Button
		public String StepGroupVariablesXpath="//a[text()='Variables']";
		//Local Variables Button
		public String LocalVariablesXpath="//label[text()='Local Variables']";
		//Local Variables Button
		public String StepGroupVariableXpath="//label[text()='Step Group Variables']";
		...
		public String Expand="//button[@title=\"Expand All\"]";
		public String Collapse="//button[@title=\"Collapse All\"]";
