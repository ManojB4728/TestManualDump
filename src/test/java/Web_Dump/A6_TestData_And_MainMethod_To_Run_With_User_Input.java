...
//-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------		
	...
	// Email Id
	public String EmaiId = "afshanckm2001@gmail.com";
	// Password
	public String Password = "Password@123";
	// Praject Name(Pass The Parject Name As Execitly As In Fireflink)
	public String PrajectName = "Recotap";
	// Module Name(Pass The First Module Name As Execitly As In Fireflink)
	public String CreatedBy = "Sagar";
	// Created By
	public String ReviewedBy = "Raghuram";
	// Test Description
	public String TestDescription = null;
	public String ScripetName = TestDescription;
	// Remove Thing You Don't Want In Dumping
	public List<String> removingWord = Arrays.asList("Wait", "press","Refresh browser","Browser window scroll","Mouse drag and drop","Print Value","listbox","Get text","Get size","excel", "Generate random", "Concatenate objectiveName","Concatenate","DesiredCapability");
