...
public class A4_Getting_Finalized_Text_From_Script extends A2_User_Defined_Methodes {
	
   public static void gettingTextFromScripet(String ScriptName) throws InterruptedException{
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        WebDriverWait s1432=  new WebDriverWait(driver, Duration.ofSeconds(40));
        try {
			s1432.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath("//span[@title='"+ScriptName+"']")));
		} catch (Exception e1) {
        ...
        ((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", driver.findElement(By.xpath("//span[@title='"+ScriptName+"' and @class=\"fancytree-title tree-folder-title-repo-module-width\"]")));

         WaitAndPerformAction(driver, "//span[@title='"+ScriptName+"' and @class=\"fancytree-title tree-folder-title-repo-module-width\"]", 40);
         
         driver.findElement(By.xpath("//span[@title='"+ScriptName+"' and @class=\"fancytree-title tree-folder-title-repo-module-width\"]")).click();
         System.out.println("cliked  sd");
         
         WaitAndPerformAction(driver, m1.ClearResultButtonXpath, wait);
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
        Thread.sleep(2500);
